...
class ThirdLevel3:
    def __init__(self):
        ...
        self.start_set = True
        self.level = 2
        self.info = info.Info('third_level_3.json')
    ...
    def setup_background(self):
        self.background = setup.graphics['map_3.3']
    ...
    def update(self, surface, keys, press):
        ...
        if self.start_set:
            ...
            self.enemies_pos_1 = [(200, 330), (200, 380), (200, 430)]
            self.enemies_pos_2 = [(420, 650), (420, 700)]
            functions.setup_enemy(3, 'LAB_robot_W', self.player, self.enemies, self.enemies_pos_1)
            functions.setup_enemy(2, 'LAB_robot_R', self.player, self.enemies, self.enemies_pos_2)
